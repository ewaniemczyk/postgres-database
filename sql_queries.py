...
songplay_table_create = ("""
                        ...
                        (songplay_id SERIAL PRIMARY KEY, start_time timestamp, user_id int, level varchar, song_id int, 
...
user_table_create = ("""
                    ...
                    (user_id varchar PRIMARY KEY, first_name varchar, last_name varchar, gender varchar, level varchar);
                    """)
